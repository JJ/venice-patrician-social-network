...
The beginning of the republic of Venice \cite{madden2012venice} is (possibly mythically) set in 697, with Paolo Lucio Anafesto converting from a Byzantine governor to the first leader of the independent city of Venice. This tradition does not have any source, but at any rate, it started the institution of doges as *elected* leaders. Since back then Venice was little more than a settlement, a popular assembly elected them directly.

After a brief period when Venice was part of the exarchate of Ravenna and was governed by a military administration, dogarate was restored in 742, with doges, once again, elected popularly. This period was not particularly stable. Many doges were deposed or directly killed. In a case, Pietro IV Candiano and his son were locked in palace by the populace, after which it was set afire. In 
