...
```{r sna1, , echo=FALSE,fig.height=10, fig.cap="Patrician families social networks through weddings. Circles indicate that family has both; balls only doges, and squares only dogaresse"}
...
plot(venice.sn,vertex.size=10,vertex.shape=V(venice.sn)$shapes,vertex.color=V(venice.sn)$colors,layout=layout_with_fr, vertex.label.cex=0.7)
```
