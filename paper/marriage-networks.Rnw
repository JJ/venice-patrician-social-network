...
<<r split.families, echo=F, fig.cap="Graph representation of data processed using the \"split families\" method, that considers separately husbands and wives in the marital network. \"Husband\" nodes are colored in blue, \"Wife\" nodes in gold.\\protect\\label{fig:sf}">>=
