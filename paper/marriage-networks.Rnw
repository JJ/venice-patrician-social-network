...
\title{Incorporating intra-family couples into the analysis of family marriage networks}
...
JJ Merelo has prepared data and written code to process it, written and revised the article.
...
\bibliography{geneura}      % Bibliography file (usually '*.bib' )
