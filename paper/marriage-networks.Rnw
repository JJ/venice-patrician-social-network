...
<<r newnodes, echo=F, fig.cap="Graph representation of the marital network enhanced with new nodes representing intra-family connections. Links are not weighted, and the representation uses the best available; \"new\" nodes are represented in yellow.\\protect\\label{fig:newnodes}">>=
