...
The effect on eigenvector centrality \ref{ruhnau2000eigenvector}, observed when comparing \ref{tab:top:EV} and \ref{tab:top:EV.dup}, is even more interesting. The "non-family" node that includes all non-patrician wifes is no longer first in the ranking, having been overcome by the Contarini family, which we know has a high number of intra-family marriages, as seen in Table \ref{tab:top}. This reflects the fact that since there is an important "path" created between both Contarini family nodes, they have been able to increase this measure. As a matter of fact, since it is a big family, it would be almost impossible to severe links to the {\em whole} family. By this artifact of duplicating the nodes, we create an alternate way of arriving to any part of the family, directly or through other, separate, part of the family. This creates an interesting interpretation for this "replicated" nodes. It simply represents "other" part of the family that is not directly related to "this" part of the family. By not making it fixed by splitting the family along patri- or matri-linear lines, but simply indicating the fact that there are different, non-directly related parts of the family with these two nodes, we can capture part of the social dynamics in these extended families and incorporate them into the analysis of marital networks.
