...
plot(marriages.newnodes, vertex.size=5)
@
...
<<r split.families, echo=F, fig.cap="Graph representation of the \"split families\" method, that considers separately husbands and wives in the marital network.\\protect\\label{fig:sf}">>=
