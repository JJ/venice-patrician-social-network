...
kable(doge.marriage.ev.table[ doge.marriage.ev.table$degree> 0.1,],caption="Ranking of families in the exclusive dogal marriage network according to eigenvector centrality; only those with a value higher than 0 are shown.")
