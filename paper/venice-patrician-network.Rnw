...
<<r contarini.diges, echo=F, fig.cap="Number of marriages in the Contarini family and dates when they became doges.\\protect\\label{fig:contarini:doges}">>=
...
But was there any relationship between the number of marriages and a member of the family becoming a doge?
