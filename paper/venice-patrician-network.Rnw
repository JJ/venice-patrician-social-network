...
<<r weighted.plot, echo=FALSE,fig.pos="h!tbp", fig.env="figure*", fig.cap="Plotting the type of family along with actual weights. Please see text for interpretation of shape and colors">>=
types <- NULL
colors <- NULL
