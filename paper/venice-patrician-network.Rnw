...
But was there any reason to choose a set of families over others for the first Serrata? Let's look at the EV centrality within the noble families. This is represented in Figure \ref{fig:col.noble.bp.serrata}.
...
Most of these are found in the biggest connected component in this network, including the disgraced family Faliero or Falier, that includes the only doge that was ever beheaded after the Serrata. This component is shown in Figure \ref{fig:dogal.minus.marriage.big}.
%
