...
Out of the \Sexpr{length(V(venice.colleganza.sn))} families that are included in the dataset, 108 are connected; most families, in one way or another, participated in these joint ventures, with varying allegiances through time.
