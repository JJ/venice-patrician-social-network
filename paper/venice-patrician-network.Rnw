...
But was there any reason to choose a set of families over others for the first \emph{Serrata}? Let's look at the EV centrality within the noble families. This is represented in Figure \ref{fig:col.noble.bp.serrata}.
