...
<<r weighted.plot, echo=FALSE,fig.pos="h!tbp", fig.height=6, fig.env="figure*", fig.cap="Plotting the type of family along with actual weightsin the colleganza network. Please refer to text for interpretation of shape and colors. \\protect\\label{fig:colw}">>=
types <- NULL
colors <- NULL
