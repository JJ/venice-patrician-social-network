...
\Sexpr{format(round(100*length(marriages[ marriages$husband_familyname_std == 'Contarini' | marriages$wife_familyname_std == 'Contarini',]$year)/length(marriages$year),2),nsmall=2)}\% of all weddings.
