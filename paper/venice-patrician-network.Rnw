...
kable(betw.table[ betw.table$Betweenness> 0.25,],caption="Ranking of families according to eigenvector centrality; only those with a value higher than 0.25 are shown")
@
