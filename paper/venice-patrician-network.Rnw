...
kable(betw.table[ betw.table$Betweenness> 0.1,],caption="Ranking of families in the colleganza network according to eigenvector centrality; only those with a value higher than 0.1 are shown.")
@

Please also check that the Soranzo family, which was the subject of Ryabova et al.'s papers \cite{ryabova2016social,ryabova2019venetian}, is also part of this ranking, showing their standing in the social network and making them a good representative of the noble/trading families at large, supporting the validity of their analysis.
...
high.ev.families.df <- data.frame("Morosini group" = c(as_ids(V(venice.colleganza.sn)[cnet$membership==2]),rep("",5)),
                                  ...
                                  check.names = FALSE)
kable(high.ev.families.df,caption="Groups (clusters) of families that include those with the highest eigenvector centrality, named by the most characteristic \\protect{\\em casa} in them.")
@
