...
types <- NULL
colors <- NULL
family.colors <- list("Ancient"="lightgray","Extinct pre-serrata"="gray","Evangeliche"="gold","Nuove"="lightgreen",
...
plot(venice.colleganza.sn,vertex.size=10,vertex.shape=V(venice.colleganza.sn)$types, vertex.label.cex=0.7)
@
